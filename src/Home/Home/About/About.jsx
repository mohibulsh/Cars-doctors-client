...
const About = () => {
    return (
        ...
        <div className="hero-content flex-col lg:flex-row">
          ...
          <img src={parts} className=" w-72 border-8 border-white top-2/3 left-1/2 absolute rounded-lg shadow-2xl" />
          </div>
          <div className='w-1/2 space-y-3 p-4'>
             <h3 className='text-3xl font-bold text-orange-500'>About Us</h3>
            <h1 className="text-5xl font-bold">We are qualified & of experience in this field</h1>
            <p className="py-6">There are many variations of passages of
